...
public class BeanConfiguration {
  ...
  @Bean
  DepartmentPersistenceAdapter departmentPersistenceAdapter(
  ...
  @Bean
  OrganisationPersistenceAdapter organisationPersistenceAdapter(
      ModelMapper modelMapper,
      OrganisationRepository organisationRepository,
      AdminRowRepository adminRowRepository) {
    return new OrganisationPersistenceAdapter(
        modelMapper, organisationRepository, adminRowRepository);
  }
